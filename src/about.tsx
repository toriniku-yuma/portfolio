export function About(){
    return(
        ...
        <div className=' relative'>
            <img className=' w-[60rem] right-40 md:relative' src='./VRChat.png'/>
            <div className='bg-base-200 md:absolute first-line -right-32 -bottom-10 flex flex-col items-center p-5 shadow-md'>
